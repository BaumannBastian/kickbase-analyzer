# ------------------------------------
# apply_history_views_with_bq_cli.py
#
# Dieses Skript erzeugt/aktualisiert History-CORE- und History-MARTS-
# Views in BigQuery per bq CLI.
#
# Outputs
# ------------------------------------
# 1) BigQuery Views in <project>.<core> (v_hist_*)
# 2) BigQuery Views in <project>.<marts> (mart_hist_*)
#
# Usage
# ------------------------------------
# - python -m bigquery.core_transform.apply_history_views_with_bq_cli --project <project>
# ------------------------------------
...
DEFAULT_CORE_SQL = Path("bigquery/sql/core_history_views.sql")
DEFAULT_MARTS_SQL = Path("bigquery/sql/marts_history_views.sql")


def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Apply history CORE and MARTS BigQuery views via bq CLI.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("BigQuery history CORE/MARTS views applied.")
    return 0
