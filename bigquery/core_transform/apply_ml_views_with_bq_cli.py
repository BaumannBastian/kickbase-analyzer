# ------------------------------------
# apply_ml_views_with_bq_cli.py
#
# Dieses Skript erzeugt/aktualisiert ML-CORE- und ML-MARTS-Views in
# BigQuery per bq CLI.
#
# Outputs
# ------------------------------------
# 1) BigQuery Views in <project>.<core> (v_ml_*)
# 2) BigQuery Views in <project>.<marts> (mart_ml_*)
#
# Usage
# ------------------------------------
# - python -m bigquery.core_transform.apply_ml_views_with_bq_cli --project <project>
# ------------------------------------
...
DEFAULT_CORE_SQL = Path("bigquery/sql/core_ml_views.sql")
DEFAULT_MARTS_SQL = Path("bigquery/sql/marts_ml_views.sql")


def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Apply ML CORE and ML MARTS BigQuery views via bq CLI.")
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print("BigQuery ML CORE/MARTS views applied.")
    return 0
