# ------------------------------------
# load_history_with_bq_cli.py
#
# Dieses Skript laedt selektive History-RAW JSONL Exporte per bq CLI
# nach BigQuery.
#
# Outputs
# ------------------------------------
...
# Usage
# ------------------------------------
# - python -m bigquery.raw_load.load_history_with_bq_cli --project <project>
# - python -m bigquery.raw_load.load_history_with_bq_cli --project <project> --write-disposition truncate
# ------------------------------------
...
TABLE_FILE_MAP = {
    "hist_player_profile_snapshot": "hist_player_profile_snapshot.jsonl",
    "hist_team_snapshot": "hist_team_snapshot.jsonl",
    "hist_player_marketvalue_daily": "hist_player_marketvalue_daily.jsonl",
    "hist_player_match_summary": "hist_player_match_summary.jsonl",
    "hist_player_match_components": "hist_player_match_components.jsonl",
    "hist_team_lineup_players": "hist_team_lineup_players.jsonl",
    "hist_team_odds_snapshot": "hist_team_odds_snapshot.jsonl",
}


def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Load selective history JSONL exports into BigQuery via bq CLI.")
    ...
    parser.add_argument("--input-dir", type=Path, default=Path("data/warehouse/raw_history"))
...
def run_load_history_with_bq_cli(
    *,
    project: str,
    dataset: str,
    location: str,
    ...
    print("BigQuery history RAW load finished.")
    return {
        "status": "success",
        "project": project,
        "dataset": dataset,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    summary = run_load_history_with_bq_cli(
        project=project,
